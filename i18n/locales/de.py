...
PAIRS = [
    ('“Luigi did a great job figuring out where was best to stop and swim.”<span class="hero-pull-attr"> — Maria, Sep 2026</span>',
     '„Luigi hat super entschieden, wo wir am besten anhalten und schwimmen.“<span class="hero-pull-attr"> — Maria, Sep. 2026</span>'),
    ('“Fantastic trip over four days — Luigi and Laura are the best captain and hostess you could ask for.”<span class="hero-pull-attr"> — Michael, Sep 2026</span>',
     '„Fantastische vier Tage — Luigi und Laura sind der beste Kapitän und die beste Hostess, die man sich wünschen kann.“<span class="hero-pull-attr"> — Michael, Sep. 2026</span>'),
    ('“The boat is mind blowing — Luigi and Laura made sure we had a great time.”<span class="hero-pull-attr"> — Simon, Aug 2026</span>',
     '„Das Boot ist umwerfend — Luigi und Laura haben dafür gesorgt, dass wir eine tolle Zeit hatten.“<span class="hero-pull-attr"> — Simon, Aug. 2026</span>'),
    ('“Laura and Luigi did a very great job — communication before the trip was excellent.”<span class="hero-pull-attr"> — Dominik, Aug 2026</span>',
     '„Laura und Luigi haben einen wirklich großartigen Job gemacht — die Kommunikation vor der Tour war ausgezeichnet.“<span class="hero-pull-attr"> — Dominik, Aug. 2026</span>'),
    ...
    ('href="#charters-land">Prices</a>', 'href="#charters-land">Preise</a>'),
    ('onclick="closeMobile()">Charters</a>', 'onclick="closeMobile()">Charter</a>'),
    ('class="mobile-nav-cta" onclick="closeMobile()">Check dates</a>', 'class="mobile-nav-cta" onclick="closeMobile()">Termine prüfen</a>'),
    ('class="nav-cta nav-header-cta" style="display:none">Check dates</a>', 'class="nav-cta nav-header-cta" style="display:none">Termine prüfen</a>'),
    ...
    (
        'Half-day (4h) from €2,200 · 6h from €3,100 · full day from €4,000',
    ...
    (
        ...
        '<strong>Limitless</strong> ist eine Maiora-Flybridge für Mallorcas schönste Buchten — warm, geräumig und auf Charter-Standard gewartet.',
    ),
    (
    ...
    (
        '<p class="section-forward-cta reveal">Like what you see? <a href="#avail-cal">Check available dates</a> or <a href="https://wa.me/34643678072?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20a%20charter%20on%20Limitless.">send a quick message</a> — the captain and crew will help shape your trip with a clear, honest picture, usually within the hour.</p>',
        '<p class="section-forward-cta reveal">Gefällt Ihnen, was Sie sehen? <a href="#avail-cal">Verfügbare Termine prüfen</a> oder <a href="https://wa.me/34643678072?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20a%20charter%20on%20Limitless.">eine kurze Nachricht schicken</a> — Kapitän und Crew helfen Ihnen, den Törn mit einem klaren, ehrlichen Bild zu gestalten, in der Regel innerhalb einer Stunde.</p>',
    ),
    ("The Yacht", "Die Yacht"),
    ...
    ("Prefer email? Write to us", "Lieber per E-Mail? Schreiben Sie uns"),
    ('id="heroAvailCta">Check available dates</a>', 'id="heroAvailCta">Verfügbare Daten prüfen</a>'),
    ("Send", "Senden"),
    (
    ...
    ("Dates", "Daten"),
    ('View Dates', 'Termine ansehen'),
    ('data-label-one="Enquire on WhatsApp for {date}"', 'data-label-one="Auf WhatsApp anfragen für {date}"'),
    ('data-label-range="Enquire on WhatsApp for {date}"', 'data-label-range="Auf WhatsApp anfragen für {date}"'),
    ('aria-label="Clear date selection"', 'aria-label="Datumsauswahl löschen"'),
    ...
    ('<a href="#hero">Home</a>', '<a href="#hero">Startseite</a>'),
    ('href="yacht-charter-mallorca/">Charters</a>', 'href="yacht-charter-mallorca/">Charter</a>'),
    ('href="maiora-yacht-charter/">The Yacht</a>', 'href="maiora-yacht-charter/">Die Yacht</a>'),
    ('onclick="closeMobile()">The Yacht</a>', 'onclick="closeMobile()">Die Yacht</a>'),
    ('href="yacht-charter-mallorca-prices/">Prices</a>', 'href="yacht-charter-mallorca-prices/">Preise</a>'),
    ('onclick="closeMobile()">Prices</a>', 'onclick="closeMobile()">Preise</a>'),
    ('href="#avail-cal">Contact</a>', 'href="#avail-cal">Kontakt</a>'),
    ('<span class="footer-heading">Charters</span>', '<span class="footer-heading">Charter</span>'),
    ('<span class="footer-heading">Destinations</span>', '<span class="footer-heading">Reiseziele</span>'),
    ('<span class="footer-heading">Info</span>', '<span class="footer-heading">Infos</span>'),
    ('href="sunset-charter-mallorca/">Half-day &amp; sunset</a>', 'href="sunset-charter-mallorca/">Halbtag &amp; Sonnenuntergang</a>'),
    ('href="multi-day-charter-balearics/">Multi-day</a>', 'href="multi-day-charter-balearics/">Mehrtage</a>'),
    ('href="yacht-charter-palma-club-de-mar/">Club de Mar, Palma</a>', 'href="yacht-charter-palma-club-de-mar/">Club de Mar, Palma</a>'),
    ("href=\"what-is-included/\">What's included</a>", 'href="what-is-included/">Was inklusive ist</a>'),
    ('href="best-time-yacht-charter-mallorca/">Best time to charter</a>', 'href="best-time-yacht-charter-mallorca/">Beste Reisezeit</a>'),
    ('href="destinations/ibiza-formentera/">Ibiza &amp; Formentera</a>', 'href="destinations/ibiza-formentera/">Ibiza &amp; Formentera</a>'),
    ...
    ("Decline", "Ablehnen"),
    ("Accept", "Akzeptieren"),
    ('<span class="lb-close-label">Close</span>', '<span class="lb-close-label">Schließen</span>'),
    (
    ...
    (
        ...
        'Chartern Sie die 21,5 m Maiora „Limitless“ ab Palma de Mallorca — Tages- und Mehrtagestörns zu Mallorcas schönsten Buchten, Cabrera und Formentera. Mit Crew, bis zu 12 Gäste.',
    ),
    (
        ...
        'Tages- und Mehrtagescharter auf der 21,5 m Maiora „Limitless“ ab Palma — Mallorcas Buchten, Cabrera und Formentera, mit außergewöhnlicher Crew.',
    ),
    (
        '>Destinations</a>',
        '>Reiseziele</a>',
    ...
    (
        ...
        'onclick="closeMobile()">Reiseziele</a>',
    ),
    (
        '>Gallery</p>',
        '>Galerie</p>',
    ...
    (
        ...
        'Club de Mar · Mallorca · Mittelmeer',
    ),
    (
    ...
    (
        ...
        '· Verifizierte Gästebewertungen',
    ),
    (
        'Where <em>Limitless</em> Takes You',
        'Wohin <em>Limitless</em> Sie bringt',
    ),
    (
        'Metres of luxury',
        'Meter Luxus',
    ...
    (
        ...
        'Was Limitless wirklich auszeichnet, ist ihre <strong>engagierte Crew</strong>. Aufmerksam, erfahren und mit echter Leidenschaft fürs Meer kümmern sie sich um alles — vom Catering bis zur Reservierung im Beach Club —, damit Sie sich ganz auf Ihre Begleitung und die Orte konzentrieren können, die Sie entdecken.',
    ),
    (
        ...
        'Die unten gezeigten Ziele und Routen sind <strong>nur Vorschläge</strong>. Jeder Törn ist <strong>ganz auf Sie zugeschnitten</strong> — unsere erfahrene Crew plant gemeinsam mit Ihnen im Voraus oder sogar <strong>am Tag selbst</strong> (je nach Wetter) die perfekte Route, ob entspannte Halbtagestour, Ganztagestörn oder mehrtägige Reise entlang Mallorcas schönsten Küsten. <strong>Flexible Tagesoptionen</strong>, die <strong>Freiheit zu übernachten, wann immer Ihnen danach ist</strong>, und die <strong>Möglichkeit, Catering oder Beach-Club-Zugang zu arrangieren</strong> gehören selbstverständlich dazu.',
    ),
    (
        'Suggested Half-Day Escapes ',
        'Empfohlene Halbtagestouren ',
    ),
    (
        '— 4 to 6 hours',
        '— 4 bis 6 Stunden',
    ...
    (
        ...
        'Empfohlene Ganztagestörns ',
    ),
    (
        '— a full day out',
        '— ein ganzer Tag auf See',
    ),
    (
        'Suggested Multi-Day Voyages ',
        'Empfohlene mehrtägige Reisen ',
    ),
    (
        '— overnight &amp; long-range',
        '— über Nacht &amp; weite Strecken',
    ),
    (
        '01 · Southwest Coast',
        '01 · Südwestküste',
    ...
    (
        ...
        '09 · Nordwestküste · Mehrtägig',
    ),
    (
        '10 · Full Island · Multi-Day',
        '10 · Ganze Insel · Mehrtägig',
    ),
    (
        '11 · Balearics Crossing · Multi-Day',
        '11 · Balearen-Überfahrt · Mehrtägig',
    ),
    (
        '12 · Balearics Crossing · Multi-Day',
        '12 · Balearen-Überfahrt · Mehrtägig',
    ),
    (
    ...
    (
        ...
        'Meeresgrotten &amp; türkise Buchten',
    ),
    (
        'Marine Reserve &amp; Snorkelling',
        'Meeresschutzgebiet &amp; Schnorcheln',
    ),
    (
        'Sheltered &amp; Serene',
        'Geschützt &amp; ruhig',
    ...
    (
        ...
        'Geschützte Klippen &amp; feiner Sand',
    ),
    (
        'Caribbean-White Sand',
        'Karibisch weißer Sand',
    ),
    (
    ...
    (
        ...
        'Mallorcas meistfotografierte Bucht',
    ),
    (
        'Complete 200 nm Loop',
        'Komplette 200-nm-Runde',
    ),
    (
        'White Isle &amp; Turquoise Spits',
        'Weiße Insel &amp; türkise Sandbänke',
    ),
    (
        'Wild Coves &amp; Ancient Shores',
        'Wilde Buchten &amp; uralte Küsten',
    ),
    (
        ...
        'Drei abgeschiedene Buchten an der Spitze der Halbinsel Calvià, berühmt für ihre in die Kalksteinfelsen gehauenen Meeresgrotten. Das Wasser leuchtet blaugrün — ideal zum Schwimmen, Schnorcheln und für eine kurze Auszeit nur 35 Minuten vom Hafen entfernt.',
    ),
    (
        ...
        'Ein geschütztes Meeresschutzgebiet rund um die Malgrats-Inseln und das Kap El Toro. Kristallklares, fischreiches Wasser, einfaches Schnorcheln und ein entspannter halber Tag mit Lunch vor Anker. Eine der schönsten kurzen Auszeiten für Naturerlebnisse im Wasser.',
    ),
    (
        ...
        "Eine ruhige, von Pinien gesäumte Bucht südlich von Port d'Andratx. Geschützt vor den vorherrschenden Winden, laden ihr stilles grünes Wasser und die entspannte Atmosphäre zu einem langen Lunch vor Anker oder einem friedlichen Bad ein.",
    ),
    (
        ...
        'Die unbewohnte, drachenförmige Insel Sa Dragonera ist ein Parc Natural. Ankern Sie außerhalb der Bojenlinie (von März bis September 50 m Abstand halten) und wandern Sie über die Pfade oder schnorcheln Sie im unberührten Wasser. Gern kombiniert mit einem Lunch im hübschen Hafen von Sant Elm.',
    ),
    (
        ...
        'Eine spektakuläre, von Pinien umgebene Bucht an Mallorcas Südküste, eingefasst von hohen Kalksteinwänden und mit einem feinen Sandstrand und flachem türkisfarbenem Wasser. Hervorragender Ankergrund im Sand; ein ruhiger und fotogener Stopp zum Schwimmen und für den Lunch.',
    ),
    (
        ...
        'Einer der letzten unberührten Strände Mallorcas — ein weiter Bogen aus puderweißem Sand, umspült von flachem, kristallklarem Wasser. Ankern Sie im Sand (Posidonia geschützt) und waten Sie hinein für eine wahrhaft abgeschiedene Auszeit.',
    ),
    (
        ...
        'Spaniens erster Meeres- und Landnationalpark — ein unberührtes Archipel mit kristallklarem Wasser und reicher Tierwelt. Wir besitzen die kostenlose Jahresgenehmigung und dürfen ausschließlich Mooringbojen nutzen (kein Ankern). Bojen für Übernachtungen müssen vorab reserviert werden; Tagesbojen nach dem Prinzip „first come, first served“ (selten voll). Perfekt für einen ganzen Tag oder den Auftakt einer mehrtägigen Reise.',
    ),
    (
        ...
        'Die winzige, unwirklich türkise Bucht Caló des Moro, eingerahmt von markanten Klippen — einer der bekanntesten und meistfotografierten Orte der Insel. Das nahe Cala Figuera bietet einen charmanten Fischerhafen und einen entspannten Kontrast. Ein längerer Törn, der sich wie ein echtes Reiseziel anfühlt.',
    ),
    (
        ...
        'Eine mehrtägige Reise entlang von Mallorcas spektakulärster Küste. Fahren Sie zwischen den hoch aufragenden Klippen der Serra de Tramuntana hindurch, ankern Sie vor dem markanten durchbohrten Felsen von Sa Foradada, machen Sie im hübschen Hafen von Port de Sóller fest für eine Tramfahrt in den Talort und entdecken Sie den abgeschiedenen Kieselstrand Cala Tuent am Fuße des Puig Major. Sa Calobra und die Schlucht Torrent de Pareis sind in greifbarer Nähe — der krönende Abschluss eines 2- bis 4-Nächte-Törns mit Ankerplätzen oder Marina-Stopps zum Übernachten.',
    ),
    (
        ...
        'Die ultimative mehrtägige Reise: eine komplette Umrundung Mallorcas, rund 200 Seemeilen abwechslungsreicher Küste. Vom sanften Südwesten, vorbei an der drachenförmigen Insel und den wilden Westklippen, um den spektakulären Norden und das Cap de Formentor, die Ostküste hinunter und zurück nach Hause. Flexible Route über 5–7 Tage mit Nächten vor Anker in versteckten Buchten oder längsseits in Hafenstädten — die schönste Art, die ganze Insel vom Wasser aus zu erleben.',
    ),
    (
        ...
        'Eine echte Überfahrt von rund 70 nm zum Pityusen-Archipel. Entdecken Sie Ibizas lebhafte Häfen, versteckte Buchten und legendäre Beach Clubs — mit der Option, weiter zu Formenteras weltberühmtem Ses Illetes zu fahren: die leuchtende Sandbank und das flache türkisfarbene Wasser, oft die Karibik des Mittelmeers genannt. Hochsee-Abenteuer mit dem Reiz eines ganz anderen Inselgefühls; ideal für 2–4 Nächte mit Marina-Aufenthalten oder wilden Ankerplätzen.',
    ),
    (
        ...
        'Eine landschaftlich reizvolle Überfahrt von rund 60 nm nordöstlich nach Menorca, der ursprünglichsten der großen Baleareninseln. Ankern Sie in den berühmten Buchten der Südküste wie Cala Macarella und Cala Mitjana — türkisfarbene, von Pinien gesäumte Juwelen — oder machen Sie im längsten Naturhafen der Welt bei Mahón fest. Erkunden Sie prähistorische talayotische Monumente und stille Fischerorte. Perfekt für Törns von 2–5 Nächten, mit der Option, Menorcas eigene Küste zu umrunden.',
    ),
    (
        'From Club de Mar <strong>',
        'Ab Club de Mar <strong>',
    ),
    (
        'Depth <strong>',
        'Tiefe <strong>',
    ...
    (
        ...
        'Parc Natural — nur Bojen',
    ),
    (
        'Permit held • Buoys only',
        'Genehmigung vorhanden • nur Bojen',
    ),
    (
        'Multi-day anchorages &amp; moorings',
        'Mehrtägige Anker- &amp; Liegeplätze',
    ),
    (
    ...
    (
        ...
        '<p class="section-forward-cta reveal">Möchten Sie mehr sehen? <a href="#itinerary-land">Entdecken Sie die Ziele</a> oder <a href="#gallery-land">werfen Sie einen Blick auf die Yacht</a>.</p>'
    ),
        (
    ...
    (
        ...
        'aria-label="Reiseziele entdecken"',
    ),
    (
        'aria-label="Explore the yacht"',
        'aria-label="Yacht entdecken"',
    ),
    (
        '✦</span>Explore destinations</a>',
        '✦</span>Reiseziele entdecken</a>',
    ),
    (
        '✦</span>Explore the yacht</a>',
        '✦</span>Yacht entdecken</a>',
    ),
    (
        'Low Season',
        'Nebensaison',
    ...
    (
        ...
        'class="amt-sm">ab </span>',
    ),
    (
        'class="amt-sm"> /day</span>',
        'class="amt-sm"> /Tag</span>',
    ),
    (
        'All charters',
        'Alle Charter',
    ...
    (
        ...
        'Kraftstoff &amp; Getränke extra bei Tagescharter',
    ),
    (
        'Provisioning (food & supplies) & mooring fees extra for multi-day',
        'Verpflegung (Essen &amp; Vorräte) &amp; Liegegebühren extra bei mehrtägigen Törns',
    ),
    (
        'Catering & beach club bookings can be arranged',
        'Catering &amp; Beach-Club-Reservierungen auf Wunsch',
    ),
    (
        'Multi-day & overnight charters available — priced per day. Stay as many days as you like.',
        'Mehrtägige Charter und Übernachtungstörns möglich — Preis pro Tag. Bleiben Sie so viele Tage, wie Sie möchten.',
    ),
    (
        ...
        'Echte Erlebnisse von Gästen, die <strong>Limitless</strong> gechartert haben. Bewertungen werden nach einer kurzen Prüfung veröffentlicht.',
    ),
    (
    ...
    (
        ...
        'Wir freuen uns über Ihr Feedback. Senden Sie unten Ihre Bewertung — sie wird geprüft und in Kürze veröffentlicht.',
    ),
    (
        '>Name<',
        '>Name<',
    ...
    (
        ...
        'Wie bewerten Sie Ihren Charter?',
    ),
    (
        '★★★★★ Excellent (5)',
        '★★★★★ Ausgezeichnet (5)',
    ...
    (
        ...
        'placeholder="Erzählen Sie künftigen Gästen von Ihrem Tag an Bord der Limitless..."',
    ),
    (
    ...
    (
        ...
        '✓ Vielen Dank! Ihre Bewertung ist eingegangen und wird nach der Prüfung veröffentlicht.',
    ),
    (
    ...
    (
        ...
        'Club de Mar · Palma de Mallorca · Mittelmeer',
    ),
    # --- fixes ---
    ('aria-label="Open menu"', 'aria-label="Menü öffnen"'),
    ('aria-label="Site menu"', 'aria-label="Seitenmenü"'),
    ('class="section-label reveal">Destinations<', 'class="section-label reveal">Reiseziele<'),
    ...
    (
        ...
        ' ist eine 21-Meter-Maiora mit Flybridge, Achterdeck und Sonnenliegen — Platz für zwölf Gäste tagsüber, komfortabel für sieben über Nacht. Für das Meer gebaut und auf Charter-Standard gepflegt.',
    ),
    (
        ...
        'Was Limitless wirklich auszeichnet, ist ihre <strong>engagierte Crew</strong>. Aufmerksam, erfahren und mit echter Leidenschaft für das Meer kümmert sie sich um alles — vom Organisieren des Caterings bis zur Reservierung des Beach-Club-Zugangs — damit Sie sich ganz auf Ihre Begleitung und die Orte konzentrieren können, die Sie entdecken.',
    ),
    (
        "See where you'd go",
    ...
    (
        'Every route is shaped around your group — the suggestions below are a starting point. Message the captain and crew with your dates and you\'ll get a realistic plan for your trip.',
        'Jede Route richtet sich nach Ihrer Gruppe — die folgenden Vorschläge sind ein Ausgangspunkt. Schreiben Sie Kapitän und Crew mit Ihren Terminen — Sie erhalten einen realistischen Plan für Ihren Törn.',
    ),
    (
        'Half-Day',
        'Halbtags',
    ...
    (
        ...
        'Ein geschütztes Meeresschutzgebiet rund um die Malgrats-Inseln und das Kap El Toro. Kristallklares, fischreiches Wasser, einfaches Schnorcheln und ein entspannter halber Tag mit Mittagessen vor Anker.',
    ),
    (
        ...
        "Eine ruhige, von Pinien gesäumte Bucht etwas südlich von Port d'Andratx. Geschützt vor den vorherrschenden Winden — perfekt für ein langes Mittagessen vor Anker oder ein ruhiges Bad.",
    ),
    (
        ...
        'Die unbewohnte, drachenförmige Insel Sa Dragonera ist ein Naturpark (Parc Natural). Schnorcheln Sie im unberührten Wasser und essen Sie anschließend im hübschen Hafen von Sant Elm zu Mittag.',
    ),
    (
        ...
        'Eine eindrucksvolle Bucht, umschlossen von hoch aufragenden Kalksteinwänden, die sich zu einem Sandstrand mit flachem, türkisfarbenem Wasser öffnet. Friedlich, fotogen und ideal zum Schwimmen und für ein Mittagessen.',
    ),
    (
        ...
        'Einer von Mallorcas letzten unberührten Stränden — puderweicher weißer Sand und flaches, glasklares Wasser. Ankern Sie und waten Sie hinein für eine wahrhaft abgeschiedene Auszeit.',
    ),
    (
        ...
        'Spaniens erster maritim-terrestrischer Nationalpark. Wir verfügen über die jährliche Genehmigung — kristallklares Wasser, reiche Tierwelt und ein echtes Gefühl von Abgeschiedenheit, nur 90 Minuten von der Marina entfernt.',
    ),
    (
        'Permit held · Buoys only',
        'Genehmigung vorhanden · Nur Bojen',
    ...
    (
        ...
        'Die unwirklich türkisfarbene Bucht von Caló des Moro, gerahmt von dramatischen Klippen — einer der ikonischsten Orte der Insel. Kombinieren Sie sie mit dem charmanten Fischerhafen von Cala Figuera für etwas Abwechslung.',
    ),
    (
        'Northwest Coast',
        'Nordwestküste',
    ...
    (
        ...
        'Mallorcas dramatischste Küste — die hoch aufragenden Klippen der Serra de Tramuntana, der durchbohrte Fels von Sa Foradada, das Hafenstädtchen Port Sóller und der abgeschiedene Kieselstrand von Cala Tuent. 2–4 Nächte.',
    ),
    (
        'Anchorages &amp; moorings',
        'Ankerplätze &amp; Liegeplätze',
    ),
    (
        'Full Island',
        'Ganze Insel',
    ...
    (
        ...
        'Die ultimative Mallorca-Reise — die gesamten 200 sm Küste, von den wilden Westklippen und dem Cap de Formentor bis zu den ruhigen Buchten im Osten und zurück. 5–7 flexible Tage vor Anker oder in Hafenstädten.',
    ),
    (
        'Balearics Crossing',
        'Balearen-Überfahrt',
    ...
    (
        ...
        'Eine Überfahrt von ~70 sm über offene See zu Ibizas lebhaften Häfen und versteckten Buchten, mit der Option, weiter nach Formenteras Ses Illetes zu fahren — die Karibik des Mittelmeers. 2–4 Nächte.',
    ),
    (
        'Marina or anchorage',
    ...
    (
        ...
        '~60 sm nordöstlich nach Menorca — die ursprünglichste Baleareninsel. Ankern Sie in Cala Macarella und Cala Mitjana, machen Sie im riesigen Naturhafen von Mahón fest und entdecken Sie ruhige Fischerorte. 2–5 Nächte.',
    ),
    (
    ...
    (
        ...
        'Tippen Sie auf eine Dauer, um passende Reiseziele zu sehen',
    ),
    (
        'Request a quote',
        'Angebot anfordern',
    ...
    (
        ...
        '„Geräumig, komfortabel und makellos sauber — die Crew sorgte dafür, dass wir überall bestens versorgt waren.“',
    ),
    (
        ' — Tony, Aug 2025',
        ' — Tony, Aug. 2025',
    ...
    ('CHECK AVAILABILITY →', 'VERFÜGBARKEIT PRÜFEN →'),
    ("Found a route you like? Message the captain and crew — they'll help you plan it properly.", "Eine Route gefunden, die Ihnen gefällt? Schreiben Sie Kapitän und Crew — sie helfen Ihnen, sie richtig zu planen."),
    ("Liked what you see? A short message to the captain and crew is the best way to plan your charter.", "Gefällt Ihnen, was Sie sehen? Eine kurze Nachricht an Kapitän und Crew ist der beste Weg, Ihren Charter zu planen."),
    ...
    ('Sleep under the stars and wake in a new bay each morning. Ideal for a birthday, anniversary, or simply switching off properly. A quick message to the captain and crew and we\'ll map anchorages, mileage and running costs for your dates — all laid out upfront.', 'Schlafen Sie unter dem Sternenhimmel und wachen Sie jeden Morgen in einer neuen Bucht auf. Ideal für einen Geburtstag, Jahrestag oder um wirklich abzuschalten. Eine kurze Nachricht an Kapitän und Crew — wir skizzieren Ankerplätze, Strecken und laufende Kosten für Ihre Termine, alles offen von Anfang an.'),
    ("Island-hop at your own pace — Formentera, Ibiza, Menorca or Mallorca's remotest coves. Your route, entirely bespoke — the captain and crew will sketch distances, fuel and mooring realistically in a personal reply, nothing held back.", 'Auf eigene Faust durch die Inseln — Formentera, Ibiza, Menorca oder Mallorcas entlegenste Buchten. Ihre Route, ganz nach Wunsch — Kapitän und Crew skizzieren Distanzen, Kraftstoff und Liegeplatz realistisch in einer persönlichen Antwort, ohne etwas zurückzuhalten.'),
    ('>Enquire →</span>', '>Anfragen →</span>'),
    ('Get Your Quote', 'Angebot anfordern'),
    ('Available year-round &nbsp;·&nbsp; Personal reply from captain &amp; crew', 'Ganzjährig verfügbar &nbsp;·&nbsp; Persönliche Antwort von Kapitän &amp; Crew'),
    ...
    ("A few details are all we need. The captain and crew will come back personally — usually within 24 hours — with route ideas, a transparent breakdown (fuel, mooring, provisions on multi-day) and what's optional, like gratuity. Clear picture upfront, no commitment.", 'Ein paar Angaben genügen. Kapitän und Crew melden sich persönlich — in der Regel innerhalb von 24 Stunden — mit Routenideen, einer transparenten Kostenaufstellung (Kraftstoff, Liegeplatz, Verpflegung bei mehrtägigen Törns) und was optional ist, wie Trinkgeld. Alles klar von Anfang an, unverbindlich.'),
    ...
    (
        ...
        'Siehe den <a href="#avail-cal" class="form-date-hint-link">Kalender</a> für eine Übersicht — oder wählen Sie oben freie Datum(en).',
    ),
    ('Tap a start date.', 'Startdatum antippen.'),
    (
        'Tap your end date for multi-day, or Done for one day.',
        'Enddatum für Mehrtägig antippen oder Fertig für einen Tag.',
    ),
    ('Tap Done when ready.', 'Fertig antippen, wenn Sie bereit sind.'),
    ...
    # Specs section CTA
    ("Unsure what fits your time or budget? A quick message to the captain and crew — they'll map options and costs honestly within 24 hours.", 'Unsicher, was zu Ihrem Zeitraum oder Budget passt? Eine kurze Nachricht an Kapitän und Crew — sie skizzieren Optionen und Kosten ehrlich innerhalb von 24 Stunden.'),
...
REVIEWS = [
    {
        ...
        "rating": 5,
        "text": (
            "Luigi hat super entschieden, wo wir am besten anhalten und "
            "schwimmen. Die Verpflegung war großartig, und insgesamt war er "
            "wirklich wunderbar. Die Bootstoys haben uns riesig Spaß gemacht."
        ),
    },
    {
        "author": 'Michael',
        ...
        "rating": 5,
        "text": (
            "Fantastische vier Tage — Luigi und Laura sind der beste Kapitän und "
            "die beste Hostess, die man sich wünschen kann. Nichts war zu viel: "
            "Kommunikation vor der Reise, Route sowie Essen und Getränke haben "
            "unsere Erwartungen übertroffen. Wir empfehlen sie zu 100 % und "
            "wollen nächstes Jahr wieder buchen."
        ),
    },
    {
        "author": 'Ifa',
        ...
        "rating": 5,
        "text": (
            "Wir haben Limitless vom Club de Mar für eine Geburtstagsfeier mit "
            "einer Gruppe von sieben gechartert — und es war ein unvergesslicher "
            "Tag und Abend auf dem Wasser. Luigi, unser Skipper, war vom ersten "
            "Anruf an fantastisch: tolle Routenvorschläge, ehrliche "
            "Treibstoffschätzungen und absolute Sicherheit beim Umgang mit "
            "stürmischem Wetter am Tag selbst. Ari, unsere Hostess, hat Essen und "
            "Getränke zu einem echten Highlight gemacht, und gemeinsam haben sie "
            "alles perfekt um den Sonnenuntergang herum getaktet — für einen "
            "magischen Abend. Jedes Detail wirkte vorweggenommen, bevor wir "
            "überhaupt fragen mussten. Wir würden mit Luigi und Ari jederzeit "
            "wieder chartern; wir können sie nicht genug empfehlen."
        ),
    },
    {
        "author": 'Rayan',
    ...
    },
    {
        ...
        "rating": 5,
        "text": (
            "Was für ein außergewöhnliches Erlebnis. Das Boot ist umwerfend — ich "
            "kann es nicht hoch genug bewerten. Luigi (Skipper) und Laura (Hostess) "
            "waren super freundlich und entspannt und haben dafür gesorgt, dass wir "
            "eine tolle Zeit hatten. Paul, über den ich gebucht habe, war ebenfalls "
            "sehr hilfsbereit. Ich kann diese Leute nur wärmstens empfehlen."
        ),
    },
    {
        "author": 'Dominik',
...
LEGAL_PAIRS = [
    ...
    ('href="maiora-yacht-charter/">The Yacht</a>', 'href="maiora-yacht-charter/">Die Yacht</a>'),
    ('href="yacht-charter-mallorca-prices/">Prices</a>', 'href="yacht-charter-mallorca-prices/">Preise</a>'),
    ('href="index.html#avail-cal">Contact</a>', 'href="index.html#avail-cal">Kontakt</a>'),
    ('<span class="footer-heading">Charters</span>', '<span class="footer-heading">Charter</span>'),
    ('<span class="footer-heading">Destinations</span>', '<span class="footer-heading">Reiseziele</span>'),
    ('<span class="footer-heading">Info</span>', '<span class="footer-heading">Infos</span>'),
    ('<a href="yacht-charter-mallorca/">Private charter</a>', '<a href="yacht-charter-mallorca/">Privater Charter</a>'),
    ...
    ("Data We Collect when You Contact Us", "Daten, die wir bei Ihrer Kontaktaufnahme erheben"),
    (
        "There is no booking form on this website. If you write to us by email or WhatsApp, we process the information you choose to send (typically your name, contact details, preferred dates and any message) solely to reply and to arrange a possible charter.",
        "Diese Website hat kein Buchungsformular. Wenn Sie uns per E-Mail oder WhatsApp schreiben, verarbeiten wir die Angaben, die Sie uns senden (in der Regel Name, Kontaktdaten, Wunschtermine und eine Nachricht), ausschließlich zur Antwort und zur Abwicklung eines möglichen Charters.",
    ),
    (
        "The legal basis for this processing is your consent and the taking of steps prior to entering into a contract (Art. 6(1)(a) and (b) GDPR).",
        "Rechtsgrundlage sind Ihre Einwilligung und vorvertragliche Maßnahmen (Art. 6 Abs. 1 lit. a und b DSGVO).",
    ),
    ...
    ("Analytics and Advertising (Google tag, Microsoft Clarity &amp; Google Ads)", "Analyse und Werbung (Google-Tag, Microsoft Clarity &amp; Google Ads)"),
    (
        ...
        "Diese Website lädt das <strong>Google-Tag</strong> (gtag.js) direkt — ohne Google Tag Manager — für <strong>Google Ads</strong> Conversion-Tracking und Remarketing (ID AW-18209943491). Mit Ihrer Einwilligung nutzen wir außerdem <strong>Microsoft Clarity</strong> für Sitzungsaufzeichnungen und Heatmaps. Diese Tools helfen uns, die Nutzung der Seite zu verstehen und Werbeleistung zu messen. Dabei können Cookies gesetzt und Daten wie IP-Adresse (typischerweise gekürzt/anonymisiert), Geräte- und Browserinformationen sowie besuchte Seiten verarbeitet werden.",
    ),
    (
        ...
        "Mit Ihrer Einwilligung erfassen wir ggf. <strong>Scrolltiefe</strong> und <strong>welche Bereiche Sie ansehen</strong> (z. B. Galerie, Bewertungen, Preise), um die Seite zu verbessern. Dazu nutzen wir eigene Skripte und senden Ereignisse an die Google-Tag-Datenschicht; ohne Namenszuordnung. Clarity wird von Microsoft bereitgestellt — es gelten Microsofts Datenschutzbedingungen.",
    ),
    (
    ...
    (
        ...
        "Neben technisch notwendigen Daten (siehe Hosting) setzen wir Analyse-Cookies für Microsoft Clarity nur bei Zustimmung im Banner. Das Google-Tag für Google Ads (AW-18209943491) wird mit standardmäßig verweigerter Werbespeicherung geladen, bis Sie zustimmen. Sie können Cookies jederzeit in den Browsereinstellungen verwalten oder blockieren.",
    ),
