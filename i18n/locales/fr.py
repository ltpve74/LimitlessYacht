...
PAIRS = [
    ('“Luigi did a great job figuring out where was best to stop and swim.”<span class="hero-pull-attr"> — Maria, Sep 2026</span>',
     '« Luigi a très bien choisi les meilleurs spots pour s’arrêter et nager. »<span class="hero-pull-attr"> — Maria, sept. 2026</span>'),
    ...
    ('“One of the highlights of our stay in Mallorca.”<span class="hero-pull-attr"> — Maurice, Jun 2026</span>',
     '« L’un des temps forts de notre séjour à Majorque. »<span class="hero-pull-attr"> — Maurice, juin 2026</span>'),
    ('“One of the best days of our trip. Captain Luigi knows all the best spots.”<span class="hero-pull-attr"> — Oliver, Jul 2026</span>',
     '« Un des meilleurs jours de notre voyage. Le capitaine Luigi connaît les meilleurs spots. »<span class="hero-pull-attr"> — Oliver, juil. 2026</span>'),
    ('“Professional, thoughtful but also relaxed and fun.”<span class="hero-pull-attr"> — Andrew, Jun 2026</span>',
     '« Professionnel, attentionné, mais aussi détendu et fun. »<span class="hero-pull-attr"> — Andrew, juin 2026</span>'),
    (
    ...
    ('href="#charters-land">Prices</a>', 'href="#charters-land">Tarifs</a>'),
    ('onclick="closeMobile()">Charters</a>', 'onclick="closeMobile()">Charters</a>'),
    ('class="mobile-nav-cta" onclick="closeMobile()">Check dates</a>', 'class="mobile-nav-cta" onclick="closeMobile()">Voir les dates</a>'),
    ('class="nav-cta nav-header-cta" style="display:none">Check dates</a>', 'class="nav-cta nav-header-cta" style="display:none">Voir les dates</a>'),
    ...
    ("Private yacht charter in Mallorca · Crewed Maiora 21.5 m · 12 guests day · 7 overnight", "Charter privé à Majorque · Maiora 21,5 m avec équipage · 12 invités de jour · 7 de nuit"),
    (
        'Half-day (4h) from €1,700 · 6h from €2,400 · full day from €3,000',
        'Demi-journée (4h) à partir de 1 700 € · 6h à partir de 2 400 € · journée complète à partir de 3 000 €',
    ),
    (
        'Half-day (4h) from €2,200 · 6h from €3,100 · full day from €4,000',
        'Demi-journée (4h) à partir de 2 200 € · 6h à partir de 3 100 € · journée complète à partir de 4 000 €',
    ),
    ...
    (
        ...
        '<p class="section-forward-cta reveal">Ce que vous voyez vous plaît\xa0? <a href="#avail-cal">Voir les dates disponibles</a> ou <a href="https://wa.me/34643678072?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20a%20charter%20on%20Limitless.">envoyez un court message</a> — le capitaine et l\'équipage vous aideront à façonner le voyage avec une image claire et honnête, en général en moins d\'une heure.</p>',
    ),
    ...
    (
        ...
        "Voyez les dates libres — sélectionnez un ou plusieurs jours, puis envoyez un court message. Le capitaine et l'équipage confirmeront les disponibilités et répondront avec un aperçu honnête des itinéraires et des coûts — sans surprise cachée. Le calendrier est tenu à jour par notre équipage.",
    ),
    ...
    (
        ...
        "Appuyez sur des dates libres ou en attente — ajoutez ou retirez-en autant que vous voulez.",
    ),
    ('data-i18n-count-one="{n} day selected"', 'data-i18n-count-one="{n} jour sélectionné"'),
    ('data-i18n-count-many="{n} days selected"', 'data-i18n-count-many="{n} jours sélectionnés"'),
    ('data-i18n-enquire="Enquire about these dates"', 'data-i18n-enquire="Demander ces dates"'),
    ('data-i18n-clear="Clear"', 'data-i18n-clear="Effacer"'),
    ('data-i18n-booked="{date} is booked — try {alts}"', 'data-i18n-booked="{date} est réservé — essayez {alts}"'),
    ('data-i18n-or="or"', 'data-i18n-or="ou"'),
    (">Clear</button>", ">Effacer</button>"),
    (">Enquire about these dates</span>", ">Demander ces dates</span>"),
    (
    ...
    ("Prefer email? Write to us", "Vous préférez l'e-mail ? Écrivez-nous"),
    ('id="heroAvailCta">Check available dates</a>', 'id="heroAvailCta">Voir les dates disponibles</a>'),
    ("Send", "Envoyer"),
    (
    ...
    ("Dates", "Dates"),
    ('View Dates', 'Voir les dates'),
    ('data-label-one="Enquire on WhatsApp for {date}"', 'data-label-one="Demander sur WhatsApp pour le {date}"'),
    ('data-label-range="Enquire on WhatsApp for {date}"', 'data-label-range="Demander sur WhatsApp pour {date}"'),
    ('aria-label="Clear date selection"', 'aria-label="Effacer la sélection de dates"'),
    ...
    ('<a href="yacht-charter-mallorca/">Private charter</a>', '<a href="yacht-charter-mallorca/">Charter privé</a>'),
    ('<a href="day-charter-mallorca/">Day charter</a>', '<a href="day-charter-mallorca/">Charter à la journée</a>'),
    ('<a href="destinations/">Destinations</a>', '<a href="destinations/">Destinations</a>'),
    ('<a href="#hero">Home</a>', '<a href="#hero">Accueil</a>'),
    ('href="yacht-charter-mallorca/">Charters</a>', 'href="yacht-charter-mallorca/">Charters</a>'),
    ('href="maiora-yacht-charter/">The Yacht</a>', 'href="maiora-yacht-charter/">Le yacht</a>'),
    ('onclick="closeMobile()">The Yacht</a>', 'onclick="closeMobile()">Le yacht</a>'),
    ('href="yacht-charter-mallorca-prices/">Prices</a>', 'href="yacht-charter-mallorca-prices/">Tarifs</a>'),
    ('onclick="closeMobile()">Prices</a>', 'onclick="closeMobile()">Tarifs</a>'),
    ('href="#avail-cal">Contact</a>', 'href="#avail-cal">Contact</a>'),
    ('<span class="footer-heading">Charters</span>', '<span class="footer-heading">Charters</span>'),
    ('<span class="footer-heading">Destinations</span>', '<span class="footer-heading">Destinations</span>'),
    ('<span class="footer-heading">Info</span>', '<span class="footer-heading">Infos</span>'),
    ('href="sunset-charter-mallorca/">Half-day &amp; sunset</a>', 'href="sunset-charter-mallorca/">Demi-journée et coucher de soleil</a>'),
    ('href="multi-day-charter-balearics/">Multi-day</a>', 'href="multi-day-charter-balearics/">Plusieurs jours</a>'),
    ('href="yacht-charter-palma-club-de-mar/">Club de Mar, Palma</a>', 'href="yacht-charter-palma-club-de-mar/">Club de Mar, Palma</a>'),
    ("href=\"what-is-included/\">What's included</a>", 'href="what-is-included/">Inclus</a>'),
    ('href="best-time-yacht-charter-mallorca/">Best time to charter</a>', 'href="best-time-yacht-charter-mallorca/">Meilleure période</a>'),
    ...
    (
        ...
        "Louez le Maiora de 21,5 m « Limitless » depuis Palma de Majorque — croisières à la journée et sur plusieurs jours vers les criques de Majorque, Cabrera et Formentera. Avec équipage, jusqu'à 12 invités.",
    ),
    (
        ...
        "Croisières à la journée et sur plusieurs jours sur le Maiora de 21,5 m « Limitless » depuis Palma — criques de Majorque, Cabrera et Formentera, équipage d'exception.",
    ),
    (
        '>Details</a>',
        '>Détails</a>',
    ...
    (
        ...
        'Club de Mar · Majorque · Méditerranée',
    ),
    (
    ...
    (
        ...
        'Là où <em>Limitless</em> vous emmène',
    ),
    (
        'Metres of luxury',
        'Mètres de luxe',
    ...
    (
        ...
        "Ce qui distingue vraiment Limitless, c'est son <strong>équipage dédié</strong>. Attentionnés, expérimentés et sincèrement passionnés par la mer, ils s'occupent de tout — de l'organisation du traiteur à la réservation d'un beach club — pour que vous puissiez vous consacrer entièrement à vos proches et aux lieux que vous découvrez.",
    ),
    (
        ...
        "Les destinations et itinéraires présentés ci-dessous ne sont que des <strong>suggestions</strong>. Chaque charter est <strong>entièrement sur mesure</strong> — notre équipage expérimenté élabore avec vous, à l'avance ou même <strong>le jour même</strong> (selon la météo), l'itinéraire parfait, qu'il s'agisse d'une escapade d'une demi-journée, d'une croisière d'une journée ou d'un voyage de plusieurs jours le long des plus belles côtes de Majorque. Des <strong>options souples au jour le jour</strong>, la <strong>liberté de passer la nuit à bord quand l'envie vous prend</strong> et la <strong>possibilité d'organiser un traiteur ou l'accès à un beach club</strong> font partie de l'expérience.",
    ),
    (
        'Suggested Half-Day Escapes ',
        "Escapades d'une demi-journée suggérées ",
    ),
    (
        '— 4 to 6 hours',
        '— 4 à 6 heures',
    ...
    (
        ...
        "Croisières d'une journée suggérées ",
    ),
    (
        '— a full day out',
        '— une journée entière en mer',
    ),
    (
        'Suggested Multi-Day Voyages ',
        'Voyages de plusieurs jours suggérés ',
    ),
    (
        '— overnight &amp; long-range',
        '— nuit à bord &amp; longue distance',
    ),
    (
        '01 · Southwest Coast',
        '01 · Côte sud-ouest',
    ...
    (
        ...
        '09 · Côte nord-ouest · Plusieurs jours',
    ),
    (
        '10 · Full Island · Multi-Day',
        '10 · Île entière · Plusieurs jours',
    ),
    (
        '11 · Balearics Crossing · Multi-Day',
        '11 · Traversée des Baléares · Plusieurs jours',
    ),
    (
        '12 · Balearics Crossing · Multi-Day',
        '12 · Traversée des Baléares · Plusieurs jours',
    ),
    (
    ...
    (
        ...
        'Grottes marines &amp; criques turquoise',
    ),
    (
        'Marine Reserve &amp; Snorkelling',
        'Réserve marine &amp; snorkeling',
    ),
    (
        'Sheltered &amp; Serene',
        'Abritée &amp; sereine',
    ...
    (
        ...
        'Réserve naturelle insulaire',
    ),
    (
        'Sheltered Cliffs &amp; Fine Sand',
        'Falaises abritées &amp; sable fin',
    ),
    (
        'Caribbean-White Sand',
        'Sable blanc des Caraïbes',
    ),
    (
    ...
    (
        ...
        'Boucle complète de 200 nm',
    ),
    (
        'White Isle &amp; Turquoise Spits',
        'Île blanche &amp; langues de sable turquoise',
    ),
    (
        'Wild Coves &amp; Ancient Shores',
        'Criques sauvages &amp; rivages anciens',
    ),
    (
        ...
        "Trois criques isolées à la pointe de la péninsule de Calvià, célèbres pour leurs grottes marines creusées dans les falaises calcaires. L'eau d'un bleu-vert éclatant est idéale pour la baignade, le snorkeling et une courte escapade à seulement 35 minutes de la marina.",
    ),
    (
        ...
        "Une réserve marine protégée autour des îlots Malgrats et du cap d'El Toro. Une eau cristalline grouillante de poissons, un snorkeling facile et une demi-journée détendue avec déjeuner au mouillage. L'une des plus belles escapades nature dans l'eau.",
    ),
    (
        ...
        "Une baie paisible bordée de pins, juste au sud de Port d'Andratx. Abritée des vents dominants, son eau verte et calme et son atmosphère détendue en font l'endroit idéal pour un long déjeuner au mouillage ou une baignade tranquille.",
    ),
    (
        ...
        "L'île inhabitée en forme de dragon de Sa Dragonera est un Parc Natural. Mouillez au-delà de la ligne de bouées (gardez 50 m de mars à septembre) et parcourez les sentiers ou faites du snorkeling dans ses eaux préservées. Souvent associée à un déjeuner dans le joli port de Sant Elm.",
    ),
    (
        ...
        'Une crique spectaculaire bordée de pins sur la côte sud de Majorque, enserrée par de hautes parois calcaires et ouvrant sur une plage de sable fin aux eaux turquoise peu profondes. Excellent mouillage sur fond de sable ; une halte paisible et photogénique pour la baignade et le déjeuner.',
    ),
    (
        ...
        "L'une des dernières plages préservées de Majorque — un vaste arc de sable blanc poudreux baigné d'une eau peu profonde et cristalline. Mouillez sur le sable (posidonie protégée) et entrez dans l'eau pour une escapade vraiment isolée.",
    ),
    (
        ...
        "Le premier parc national maritime-terrestre d'Espagne — un archipel préservé aux eaux cristallines et à la faune riche. Nous détenons le permis annuel gratuit, qui donne accès uniquement aux bouées de mouillage (ancrage interdit). Les bouées de nuit doivent être réservées à l'avance ; celles de jour sont attribuées par ordre d'arrivée (rarement complètes). Parfait pour une journée entière ou le départ d'un voyage de plusieurs jours.",
    ),
    (
        ...
        "La minuscule crique au turquoise irréel de Caló des Moro, adossée à des falaises spectaculaires — l'un des sites les plus emblématiques et photographiés de l'île. Tout près, Cala Figuera offre un charmant port de pêche et un contraste paisible. Une croisière plus longue qui a des allures de véritable destination.",
    ),
    (
        ...
        "Un voyage de plusieurs jours le long de la côte la plus spectaculaire de Majorque. Faufilez-vous entre les hautes falaises de la Serra de Tramuntana, mouillez devant le célèbre rocher percé de Sa Foradada, amarrez dans le joli port de Port de Sóller pour une balade en tram jusqu'au village de la vallée, et découvrez la plage de galets isolée de Cala Tuent au pied du Puig Major. Sa Calobra et les gorges du Torrent de Pareis sont à portée — l'aboutissement idéal d'un charter de 2 à 4 nuits avec mouillages ou escales en marina pour la nuit.",
    ),
    (
        ...
        "Le voyage de plusieurs jours par excellence : un tour complet de Majorque, environ 200 milles nautiques de côtes sans cesse changeantes. Du sud-ouest paisible, en passant par l'île en forme de dragon et les falaises sauvages de l'ouest, autour du nord spectaculaire et du Cap de Formentor, puis le long de l'est et retour à la maison. Itinéraire flexible de 5 à 7 jours avec des nuits au mouillage dans des criques cachées ou à quai dans les villages portuaires — la plus belle façon de découvrir toute l'île depuis la mer.",
    ),
    (
        ...
        "Une véritable traversée d'environ 70 nm vers l'archipel des Pityuses. Découvrez les ports animés d'Ibiza, ses criques cachées et ses beach clubs légendaires, avec la possibilité de pousser jusqu'au célèbre Ses Illetes de Formentera — le banc de sable lumineux et les eaux turquoise peu profondes souvent surnommés les Caraïbes de la Méditerranée. Aventure en haute mer et dépaysement insulaire ; idéal pour 2 à 4 nuits avec escales en marina ou mouillages sauvages.",
    ),
    (
        ...
        "Une traversée pittoresque d'environ 60 nm vers le nord-est jusqu'à Minorque, la plus préservée des grandes Baléares. Mouillez dans les célèbres criques de la côte sud comme Cala Macarella et Cala Mitjana — des joyaux turquoise bordés de pins — ou amarrez dans le plus long port naturel du monde, à Mahón. Explorez les monuments talayotiques préhistoriques et les paisibles villages de pêcheurs. Parfait pour des charters de 2 à 5 nuits, avec la possibilité de faire le tour de la côte de Minorque.",
    ),
    (
        'From Club de Mar <strong>',
        'Depuis Club de Mar <strong>',
    ),
    (
        'Depth <strong>',
        'Profondeur <strong>',
    ...
    (
        ...
        'Parc Natural — bouées uniquement',
    ),
    (
    ...
    (
        ...
        'Mouillages &amp; amarrages sur plusieurs jours',
    ),
    (
        '5–7 days recommended',
        '5–7 jours recommandés',
    ),
    (
        'Marina or anchorage options',
        'Options marina ou mouillage',
    ),
    (
    ...
    (
        '>Multi-day</span>',
        '>Plusieurs jours</span>',
    ),
    (
        'class="amt-sm">from </span>',
        'class="amt-sm">dès </span>',
    ),
    (
        'class="amt-sm"> /day</span>',
        'class="amt-sm"> /jour</span>',
    ),
    (
        'All charters',
        'Tous les charters',
    ...
    (
        ...
        'Carburant &amp; boissons en sus pour les charters à la journée',
    ),
    (
        'Provisioning (food & supplies) & mooring fees extra for multi-day',
        "Avitaillement (nourriture &amp; provisions) &amp; frais d'amarrage en sus sur plusieurs jours",
    ),
    (
        'Catering & beach club bookings can be arranged',
        'Traiteur &amp; réservations en beach club sur demande',
    ),
    (
        'Multi-day & overnight charters available — priced per day. Stay as many days as you like.',
        'Croisières de plusieurs jours et avec nuit à bord disponibles — tarif par jour. Restez autant de jours que vous le souhaitez.',
    ),
    (
        ...
        'Des expériences réelles de clients ayant loué <strong>Limitless</strong>. Les avis sont publiés après une rapide modération.',
    ),
    (
    ...
    (
        ...
        'Comment noteriez-vous votre charter ?',
    ),
    (
        '★★★★★ Excellent (5)',
        '★★★★★ Excellent (5)',
    ...
    (
        ...
        'placeholder="Racontez aux futurs clients votre journée à bord du Limitless..."',
    ),
    (
    ...
    (
        ...
        'Club de Mar · Palma de Majorque · Méditerranée',
    ),
    # --- fixes ---
    ...
    (
        ...
        "Chaque itinéraire s'adapte à votre groupe — les suggestions ci-dessous ne sont qu'un point de départ. Écrivez au capitaine et à l'équipage avec vos dates et vous recevrez un plan réaliste pour votre voyage.",
    ),
    (
        'Half-Day',
        'Demi-journée',
    ...
    (
        ...
        "La haute saison (juil.–août) se remplit vite — <strong>dates d'été en quantité limitée</strong>",
    ),
    (
        'Sep – May',
        'sep – mai',
    ...
    ('aria-label="Next destination"', 'aria-label="Destination suivante"'),
    ("Seen somewhere you'd love to go? Now meet the yacht that takes you there.", "Vous avez repéré un endroit qui vous fait rêver ? Découvrez maintenant le yacht qui vous y emmène."),
    # Gallery section
    ...
    ('CHECK AVAILABILITY →', 'VÉRIFIER LES DISPONIBILITÉS →'),
    ("Found a route you like? Message the captain and crew — they'll help you plan it properly.", "Un itinéraire vous plaît ? Écrivez au capitaine et à l'équipage — ils vous aideront à le planifier correctement."),
    ("Liked what you see? A short message to the captain and crew is the best way to plan your charter.", "Vous aimez ce que vous voyez ? Un court message au capitaine et à l'équipage est la meilleure façon de planifier votre charter."),
    ...
    ("The figures above are a guide — a short message to the captain and crew is what really helps. Share your dates, group size and what you're aiming for; you'll get a personal reply with route options, realistic fuel and mooring estimates, and a clear picture of what's included vs APA on multi-day — everything upfront, nothing held back. Looking for a <a href=\"day-charter-mallorca/\">private day charter in Mallorca</a>? Half-day and full-day from Club de Mar.", "Les tarifs ci-dessus sont indicatifs — ce qui aide vraiment, c'est un court message au capitaine et à l'équipage. Indiquez vos dates, la taille du groupe et vos envies ; vous recevrez une réponse personnelle avec des itinéraires, des estimations réalistes de carburant et d'amarrage, et une image claire de ce qui est inclus ou en APA sur plusieurs jours — tout est dit d'emblée, sans surprise cachée. Vous cherchez un <a href=\"day-charter-mallorca/\">charter à la journée à Majorque</a> ? Demi-journée et journée complète au départ du Club de Mar."),
    ...
    ('Sleep under the stars and wake in a new bay each morning. Ideal for a birthday, anniversary, or simply switching off properly. A quick message to the captain and crew and we\'ll map anchorages, mileage and running costs for your dates — all laid out upfront.', "Dormez sous les étoiles et réveillez-vous dans une nouvelle baie chaque matin. Idéal pour un anniversaire ou pour vraiment décrocher. Un court message au capitaine et à l'équipage — nous esquisserons mouillages, distances et coûts d'exploitation pour vos dates, tout dit d'emblée."),
    ("Island-hop at your own pace — Formentera, Ibiza, Menorca or Mallorca's remotest coves. Your route, entirely bespoke — the captain and crew will sketch distances, fuel and mooring realistically in a personal reply, nothing held back.", "Sautez d'île en île à votre rythme — Formentera, Ibiza, Minorque ou les criques les plus reculées de Majorque. Votre itinéraire, entièrement sur mesure — le capitaine et l'équipage esquisseront distances, carburant et amarrage de façon réaliste dans une réponse personnelle, sans rien cacher."),
    ('>Enquire →</span>', '>Demander →</span>'),
    ('Get Your Quote', 'Obtenir votre devis'),
    ("Available year-round &nbsp;·&nbsp; Personal reply from captain &amp; crew", "Disponible toute l'année &nbsp;·&nbsp; Réponse personnelle du capitaine et de l'équipage"),
    ...
    ("A few details are all we need. The captain and crew will come back personally — usually within 24 hours — with route ideas, a transparent breakdown (fuel, mooring, provisions on multi-day) and what's optional, like gratuity. Clear picture upfront, no commitment.", "Quelques informations suffisent. Le capitaine et l'équipage reviendront vers vous personnellement — en général sous 24 heures — avec des idées d'itinéraire, un détail transparent (carburant, amarrage, avitaillement sur plusieurs jours) et ce qui est facultatif, comme les pourboires. Tout est clair dès le départ, sans engagement."),
    ...
    # Specs section CTA
    ("Unsure what fits your time or budget? A quick message to the captain and crew — they'll map options and costs honestly within 24 hours.", 'Vous ne savez pas ce qui convient à votre temps ou budget ? Un court message au capitaine et à l\'équipage — ils esquisseront options et coûts honnêtement sous 24 heures.'),
...
REVIEWS_UI = {
    ...
    "stars": "{n} sur 5 étoiles",
    "more": "\u2026plus",
    "less": "moins",
    "count_one": "1 avis vérifié",
    "count_many": "{n} avis vérifiés",
...
REVIEWS = [
    {
        ...
        "rating": 5,
        "text": (
            "Luigi a très bien choisi les meilleurs spots pour s'arrêter et "
            "nager. Il s'est occupé des provisions avec brio et a été vraiment "
            "formidable. On a adoré les jouets du bateau."
        ),
    },
    {
        "author": 'Michael',
    ...
    },
    {
        ...
        "rating": 5,
        "text": (
            "Nous avons affrété Limitless depuis le Club de Mar pour une "
            "célébration d'anniversaire avec un groupe de 7 personnes, et ce fut "
            "un jour et une nuit inoubliables sur l'eau. Luigi, notre skipper, "
            "a été fantastique dès le premier appel : excellentes suggestions "
            "d'itinéraire, estimations de carburant honnêtes, et une totale "
            "confiance face à des conditions orageuses le jour J. Ari, notre "
            "hôtesse, a fait de la nourriture et des boissons un véritable "
            "point fort, et ensemble ils ont cadencé parfaitement le tout "
            "autour du coucher de soleil pour une soirée magique. Chaque détail "
            "semblait anticipé avant même que nous le demandions. Nous "
            "recharterions avec Luigi et Ari sans hésiter ; nous ne saurions "
            "les recommander plus vivement."
        ),
    },
    {
        "author": 'Rayan',
    ...
    },
    {
        ...
        "rating": 5,
        "text": (
            "Nous avons passé un excellent moment à bord. Laura (hôtesse) et Luigi "
            "(skipper) ont fait un très beau travail. C'était une très belle "
            "journée à bord. La communication avant la sortie avec Paul et Luigi "
            "était excellente. Luigi a vraiment fait un effort supplémentaire pour "
            "répondre à des demandes particulières avant le voyage. Merci Laura "
            "et Luigi de nous avoir accueillis !"
        ),
    },
    {
        "author": 'Joel',
...
LEGAL_PAIRS = [
    ...
    ('href="maiora-yacht-charter/">The Yacht</a>', 'href="maiora-yacht-charter/">Le yacht</a>'),
    ('href="yacht-charter-mallorca-prices/">Prices</a>', 'href="yacht-charter-mallorca-prices/">Tarifs</a>'),
    ('href="index.html#avail-cal">Contact</a>', 'href="index.html#avail-cal">Contact</a>'),
    ('<span class="footer-heading">Info</span>', '<span class="footer-heading">Infos</span>'),
    ('<a href="yacht-charter-mallorca/">Private charter</a>', '<a href="yacht-charter-mallorca/">Charter privé</a>'),
    ('<a href="day-charter-mallorca/">Day charter</a>', '<a href="day-charter-mallorca/">Charter à la journée</a>'),
    ('href="sunset-charter-mallorca/">Half-day &amp; sunset</a>', 'href="sunset-charter-mallorca/">Demi-journée et coucher de soleil</a>'),
    ...
    ("Data We Collect when You Contact Us", "Données collectées lorsque vous nous contactez"),
    (
        ...
        "Ce site n'a pas de formulaire de réservation. Si vous nous écrivez par e-mail ou WhatsApp, nous traitons les informations que vous choisissez d'envoyer (en général nom, coordonnées, dates souhaitées et un message) uniquement pour répondre et organiser un charter éventuel.",
    ),
    (
        ...
        "La base légale est votre consentement et les mesures précontractuelles (art. 6(1)(a) et (b) RGPD).",
    ),
