...
PAIRS = [
    ...
    (
        ...
        "Voyez les dates libres — sélectionnez un jour ou une période, puis envoyez un court message. Le capitaine et l'équipage confirmeront les disponibilités et répondront avec un aperçu honnête des itinéraires et des coûts — sans surprise cachée. Le calendrier est tenu à jour par notre équipage.",
    ),
