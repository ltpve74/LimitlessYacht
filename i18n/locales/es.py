...
PAIRS = [
    ('“Luigi did a great job figuring out where was best to stop and swim.”<span class="hero-pull-attr"> — Maria, Sep 2026</span>',
     '«Luigi acertó con los mejores sitios para parar y nadar.»<span class="hero-pull-attr"> — Maria, sep. 2026</span>'),
    ('“Fantastic trip over four days — Luigi and Laura are the best captain and hostess you could ask for.”<span class="hero-pull-attr"> — Michael, Sep 2026</span>',
     '«Viaje fantástico de cuatro días — Luigi y Laura son el mejor capitán y anfitriona que se puede pedir.»<span class="hero-pull-attr"> — Michael, sep. 2026</span>'),
    ('“The boat is mind blowing — Luigi and Laura made sure we had a great time.”<span class="hero-pull-attr"> — Simon, Aug 2026</span>',
     '«El barco es impresionante — Luigi y Laura se aseguraron de que lo pasáramos genial.»<span class="hero-pull-attr"> — Simon, ago. 2026</span>'),
    ('“Laura and Luigi did a very great job — communication before the trip was excellent.”<span class="hero-pull-attr"> — Dominik, Aug 2026</span>',
     '«Laura y Luigi hicieron un trabajo excelente — la comunicación antes del viaje fue excelente.»<span class="hero-pull-attr"> — Dominik, ago. 2026</span>'),
    ...
    (
        ...
        '<strong>Limitless</strong> es una Maiora flybridge pensada para las mejores calas de Mallorca — cálida, espaciosa y mantenida a estándar de charter.',
    ),
    (
        ...
        'Su <strong>tripulación dedicada</strong> se encarga de todo: catering, reservas de beach club, todos los detalles — atenta, experimentada y con genuina pasión por el mar.',
    ),
    (
        ...
        '<p class="about-crew-note">Un equipo pequeño que reparte por igual cualquier reconocimiento que los huéspedes deseen dar — las propinas nunca son obligatorias. <a href="#charter-faq-gratuity">Bueno saber →</a></p>',
    ),
    (
    ...
    (
        ...
        '<p class="section-forward-cta reveal">¿Le gusta lo que ve? <a href="#avail-cal">Consultar fechas disponibles</a> o <a href="https://wa.me/34643678072?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20a%20charter%20on%20Limitless.">envíenos un mensaje breve</a> — el capitán y la tripulación le ayudarán a dar forma al viaje con una imagen clara y honesta, normalmente en menos de una hora.</p>',
    ),
    ...
    ("Check dates for this trip →", "Ver fechas para este viaje →"),
    ...
    (
        ...
        "Explore la vida a bordo de Limitless — en el agua, en cubierta y en los camarotes.",
    ),
    ...
    (
        ...
        "Vea las fechas libres — seleccione uno o más días y envíenos un mensaje breve. El capitán y la tripulación confirmarán la disponibilidad y responderán con un esbozo honesto de rutas y costes — sin sorpresas ocultas. El calendario lo actualiza nuestra tripulación.",
    ),
    ...
    (
        ...
        "Toque fechas libres o en espera — añada o quite tantas como necesite.",
    ),
    ('data-i18n-count-one="{n} day selected"', 'data-i18n-count-one="{n} día seleccionado"'),
    ('data-i18n-count-many="{n} days selected"', 'data-i18n-count-many="{n} días seleccionados"'),
    ('data-i18n-enquire="Enquire about these dates"', 'data-i18n-enquire="Consultar estas fechas"'),
    ('data-i18n-clear="Clear"', 'data-i18n-clear="Borrar"'),
    ('data-i18n-booked="{date} is booked — try {alts}"', 'data-i18n-booked="{date} está reservado — pruebe {alts}"'),
    ('data-i18n-or="or"', 'data-i18n-or="o"'),
    (">Clear</button>", ">Borrar</button>"),
    (">Enquire about these dates</span>", ">Consultar estas fechas</span>"),
    (
        "On hold dates are in talks with another guest — you can still enquire, and we'll let you know if they free up.",
        "Las fechas en espera están en conversaciones con otro huésped — puede consultar igualmente y le avisaremos si quedan libres.",
    ),
    ...
    ("Prefer email? Write to us", "¿Prefiere email? Escríbanos"),
    ('id="heroAvailCta">Check available dates</a>', 'id="heroAvailCta">Ver fechas disponibles</a>'),
    ("Send", "Enviar"),
    (
    ...
    ('data-label-one="Enquire on WhatsApp for {date}"', 'data-label-one="Consultar por WhatsApp el {date}"'),
    ('data-label-range="Enquire on WhatsApp for {date}"', 'data-label-range="Consultar por WhatsApp: {date}"'),
    ('aria-label="Clear date selection"', 'aria-label="Borrar fechas seleccionadas"'),
    ...
    ('<a href="#hero">Home</a>', '<a href="#hero">Inicio</a>'),
    ('href="yacht-charter-mallorca/">Charters</a>', 'href="yacht-charter-mallorca/">Chárters</a>'),
    ('href="maiora-yacht-charter/">The Yacht</a>', 'href="maiora-yacht-charter/">El yate</a>'),
    ('onclick="closeMobile()">The Yacht</a>', 'onclick="closeMobile()">El yate</a>'),
    ('href="yacht-charter-mallorca-prices/">Prices</a>', 'href="yacht-charter-mallorca-prices/">Precios</a>'),
    ('onclick="closeMobile()">Prices</a>', 'onclick="closeMobile()">Precios</a>'),
    ('href="#avail-cal">Contact</a>', 'href="#avail-cal">Contacto</a>'),
    ('<span class="footer-heading">Charters</span>', '<span class="footer-heading">Chárters</span>'),
    ('<span class="footer-heading">Destinations</span>', '<span class="footer-heading">Destinos</span>'),
    ('<span class="footer-heading">Info</span>', '<span class="footer-heading">Info</span>'),
    ('href="sunset-charter-mallorca/">Half-day &amp; sunset</a>', 'href="sunset-charter-mallorca/">Medio día y atardecer</a>'),
    ('href="multi-day-charter-balearics/">Multi-day</a>', 'href="multi-day-charter-balearics/">Varios días</a>'),
    ('href="yacht-charter-palma-club-de-mar/">Club de Mar, Palma</a>', 'href="yacht-charter-palma-club-de-mar/">Club de Mar, Palma</a>'),
    ("href=\"what-is-included/\">What's included</a>", 'href="what-is-included/">Qué incluye</a>'),
    ('href="best-time-yacht-charter-mallorca/">Best time to charter</a>', 'href="best-time-yacht-charter-mallorca/">Mejor época</a>'),
    ('href="destinations/cabrera/"', 'href="/destinations/cabrera/"'),
    ('href="destinations/es-trenc/"', 'href="/destinations/es-trenc/"'),
    ('href="destinations/sa-dragonera/"', 'href="/destinations/sa-dragonera/"'),
    ('href="destinations/portals-vells/"', 'href="/destinations/portals-vells/"'),
    ('href="destinations/ibiza-formentera/"', 'href="/destinations/ibiza-formentera/"'),
    ('href="yacht-charter-mallorca-prices/"', 'href="/yacht-charter-mallorca-prices/"'),
    ('href="what-is-included/"', 'href="/what-is-included/"'),
    ('href="best-time-yacht-charter-mallorca/"', 'href="/best-time-yacht-charter-mallorca/"'),
    ('href="yacht-charter-palma-club-de-mar/"', 'href="/yacht-charter-palma-club-de-mar/"'),
    ('href="multi-day-charter-balearics/"', 'href="/multi-day-charter-balearics/"'),
    ('href="sunset-charter-mallorca/"', 'href="/sunset-charter-mallorca/"'),
    ('href="maiora-yacht-charter/"', 'href="/maiora-yacht-charter/"'),
    ('href="day-charter-mallorca/"', 'href="/day-charter-mallorca/"'),
    ('href="yacht-charter-mallorca/"', 'href="/yacht-charter-mallorca/"'),
    ...
    ('aria-label="Close cookie banner"', 'aria-label="Cerrar banner de cookies"'),
    (
        "We use cookies for analytics and to improve the site. \n      <a href=\"legal.html\">Privacy Policy</a>.",
        "Usamos cookies para analítica y mejorar el sitio. \n      <a href=\"/es/legal.html\">Política de privacidad</a>.",
    ),
    (
        "We use cookies for analytics and to improve the site. <a href=\"legal.html\">Privacy Policy</a>.",
        "Usamos cookies para analítica y mejorar el sitio. <a href=\"/es/legal.html\">Política de privacidad</a>.",
    ),
    ...
    (
        ...
        'Resuelva correctamente la pregunta anti-spam (4 + 3 = 7).',
    ),
    (
        'Submit Review',
        'Enviar reseña',
    ...
    (
        ...
        ' es una Maiora de 21 metros con flybridge, cubierta de popa y solárium: espacio para doce invitados de día y cómodo para siete a bordo de noche. Construida para el mar y mantenida según el estándar de chárter.',
    ),
    (
        ...
        'Lo que de verdad distingue a Limitless es su <strong>tripulación dedicada</strong>. Atenta, experimentada y verdaderamente apasionada por el mar, se ocupa de todo — desde organizar el catering hasta reservar el acceso a clubes de playa — para que usted pueda centrarse por completo en su compañía y en los lugares que descubre.',
    ),
    (
        "See where you'd go",
        'Vea adónde iría',
    ...
    (
        ...
        'Cada ruta se adapta a su grupo — las sugerencias siguientes son solo un punto de partida. Escriba al capitán y la tripulación con sus fechas y recibirá un plan realista para su viaje.',
    ),
    (
        'Half-Day',
        'Medio día',
    ...
    (
        ...
        'Una reserva marina protegida en torno a los islotes Malgrats y el cabo de El Toro. Aguas cristalinas repletas de peces, snorkel fácil y un medio día relajado con almuerzo fondeados.',
    ),
    (
        ...
        "Una cala tranquila y bordeada de pinos, justo al sur de Port d'Andratx. Protegida de los vientos dominantes: perfecta para un largo almuerzo fondeados o un baño tranquilo.",
    ),
    (
        ...
        'La isla deshabitada y con forma de dragón de Sa Dragonera es un Parc Natural. Practique snorkel en sus aguas vírgenes y almuerce después en el bonito puerto de Sant Elm.',
    ),
    (
        ...
        'Una cala espectacular, encerrada por imponentes paredes de piedra caliza que se abren a una playa de arena con aguas turquesas poco profundas. Tranquila, fotogénica y perfecta para nadar y almorzar.',
    ),
    (
        ...
        'Una de las últimas playas vírgenes de Mallorca: arena blanca y fina y aguas cristalinas poco profundas. Fondee y entre caminando para una escapada realmente apartada.',
    ),
    (
        ...
        'El primer parque nacional marítimo-terrestre de España. Disponemos del permiso anual: aguas cristalinas, rica fauna y una auténtica sensación de lejanía a solo 90 minutos de la marina.',
    ),
    (
        'Permit held · Buoys only',
        'Permiso en regla · Solo boyas',
    ),
    (
        'Mallorca’s Most Photographed Cove',
        'La cala más fotografiada de Mallorca',
    ...
    (
        ...
        'La ensenada de un turquesa imposible de Caló des Moro, enmarcada por acantilados espectaculares: uno de los rincones más icónicos de la isla. Combínela con el encantador puerto pesquero de Cala Figuera para contrastar.',
    ),
    (
        'Northwest Coast',
        'Costa noroeste',
    ...
    (
        ...
        'La costa más espectacular de Mallorca: los imponentes acantilados de la Serra de Tramuntana, la roca horadada de Sa Foradada, el pueblo portuario de Port Sóller y la apartada playa de cantos de Cala Tuent. 2–4 noches.',
    ),
    (
        'Anchorages &amp; moorings',
        'Fondeaderos &amp; amarres',
    ...
    (
        ...
        'El viaje definitivo por Mallorca: las 200 mn completas de costa, desde los salvajes acantilados del oeste y el Cap de Formentor hasta las tranquilas bahías del este y vuelta. 5–7 días flexibles fondeados o en pueblos portuarios.',
    ),
    (
        'Balearics Crossing',
        'Travesía a las Baleares',
    ),
    (
        ...
        'Una travesía de ~70 mn por mar abierto hasta los animados puertos y calas escondidas de Ibiza, con la opción de continuar hasta Ses Illetes, en Formentera: el Caribe del Mediterráneo. 2–4 noches.',
    ),
    (
        'Marina or anchorage',
        'Marina o fondeadero',
    ...
    (
        ...
        '~60 mn al noreste hasta Menorca: la más virgen de las Baleares. Fondee en Cala Macarella y Cala Mitjana, amarre en el inmenso puerto natural de Mahón y descubra tranquilos pueblos pesqueros. 2–5 noches.',
    ),
    (
        'Coves &amp; natural harbour',
        'Calas &amp; puerto natural',
    ),
    (
    ...
    (
        ...
        'Toque una duración para ver los destinos correspondientes',
    ),
    (
        'Request a quote',
    ...
    (
        ...
        '«Espaciosa, cómoda e impecable: la tripulación se aseguró de que estuviéramos bien atendidos allá donde fuéramos.»',
    ),
    (
        ' — Tony, Aug 2025',
        ' — Tony, ago 2025',
    ...
    ('CHECK AVAILABILITY →', 'VER DISPONIBILIDAD →'),
    ("Found a route you like? Message the captain and crew — they'll help you plan it properly.", "¿Ha encontrado una ruta que le gusta? Escriba al capitán y la tripulación — le ayudarán a planificarla con detalle."),
    ("Liked what you see? A short message to the captain and crew is the best way to plan your charter.", "¿Le gusta lo que ve? Un mensaje breve al capitán y la tripulación es la mejor forma de planificar su charter."),
    ("Ready to create your own story on the water?", "¿Listo para crear su propia historia en el agua?"),
    ...
    ('A morning cruise, a sunset sail, or a 6-hour afternoon — swim stops and time on board without committing a full day.', 'Un paseo matutino, una salida al atardecer o una tarde de 6 horas — paradas para nadar y tiempo a bordo sin dedicar el día entero.'),
    ...
    ('Sleep under the stars and wake in a new bay each morning. Ideal for a birthday, anniversary, or simply switching off properly. A quick message to the captain and crew and we\'ll map anchorages, mileage and running costs for your dates — all laid out upfront.', 'Duerma bajo las estrellas y despierte en una bahía diferente cada mañana. Ideal para un cumpleaños, aniversario o simplemente para desconectar de verdad. Un mensaje breve al capitán y la tripulación — planificaremos fondeos, millas y costes de explotación para sus fechas, todo claro desde el principio.'),
    ("Island-hop at your own pace — Formentera, Ibiza, Menorca or Mallorca's remotest coves. Your route, entirely bespoke — the captain and crew will sketch distances, fuel and mooring realistically in a personal reply, nothing held back.", 'Isla a isla a su propio ritmo — Formentera, Ibiza, Menorca o las calas más remotas de Mallorca. Su ruta, enteramente a medida — el capitán y la tripulación esbozarán distancias, combustible y amarre de forma realista en una respuesta personal, sin ocultar nada.'),
    ('>Enquire →</span>', '>Consultar →</span>'),
    ('Get Your Quote', 'Obtener su presupuesto'),
    ('Available year-round &nbsp;·&nbsp; Personal reply from captain &amp; crew', 'Disponible todo el año &nbsp;·&nbsp; Respuesta personal del capitán y la tripulación'),
    ...
    ('Crew gratuity not included (optional, cash)', 'Propinas de tripulación no incluidas (opcional, efectivo)'),
    ('crew &amp; VAT included &nbsp;·&nbsp; gratuity optional', 'Tripulación &amp; IVA incluidos &nbsp;·&nbsp; propinas opcionales'),
    ('gratuity never required', 'propinas nunca obligatorias'),
    ...
    ("A few details are all we need. The captain and crew will come back personally — usually within 24 hours — with route ideas, a transparent breakdown (fuel, mooring, provisions on multi-day) and what's optional, like gratuity. Clear picture upfront, no commitment.", 'Con unos pocos datos basta. El capitán y la tripulación le responderán personalmente — normalmente en 24 horas — con ideas de ruta, un desglose transparente (combustible, amarre, aprovisionamiento en varios días) y lo opcional, como las propinas. Todo claro desde el principio, sin compromiso.'),
    ...
    (
        ...
        'Consulte el <a href="#avail-cal" class="form-date-hint-link">calendario</a> para una vista general — o seleccione fecha(s) libre(s) arriba.',
    ),
    ('Tap a start date.', 'Toque una fecha de inicio.'),
    (
        'Tap your end date for multi-day, or Done for one day.',
        'Toque la fecha de fin para varios días, o Listo para un solo día.',
    ),
    ('Tap Done when ready.', 'Pulse Listo cuando termine.'),
    ...
    # Specs section CTA
    ("Unsure what fits your time or budget? A quick message to the captain and crew — they'll map options and costs honestly within 24 hours.", '¿No está seguro de qué encaja con su tiempo o presupuesto? Un mensaje breve al capitán y la tripulación — le esbozarán opciones y costes con honestidad en 24 horas.'),
...
REVIEWS_UI = {
    "guest": "Huésped",
    "stars_suffix": " de 5 estrellas",
    "stars": "{n} de 5 estrellas",
    "more": "\u2026más",
    "less": "menos",
    "count_one": "1 reseña verificada",
    "count_many": "{n} reseñas verificadas",
...
REVIEWS = [
    {
        ...
        "rating": 5,
        "text": (
            "Luigi acertó con los mejores sitios para parar y nadar. Se ocupó "
            "muy bien del avituallamiento y en general fue realmente "
            "maravilloso. Disfrutamos mucho de los juguetes del barco."
        ),
    },
    {
        "author": 'Michael',
        ...
        "rating": 5,
        "text": (
            "Viaje fantástico de cuatro días. Luigi y Laura son el mejor capitán "
            "y anfitriona que se puede pedir. Nada fue demasiado: la comunicación "
            "previa, el itinerario y la comida y bebida superaron nuestras "
            "expectativas. Los recomendaríamos al 100 % y queremos volver a "
    ...
    },
    {
        ...
        "rating": 5,
        "text": (
            "Alquilamos Limitless desde el Club de Mar para una celebración de "
            "cumpleaños con un grupo de 7, y fue un día y una noche "
            "inolvidables en el agua. Luigi, nuestro patrón, fue fantástico "
            "desde la primera llamada: excelentes sugerencias de ruta, "
            "estimaciones honestas de combustible y total confianza al gestionar "
            "condiciones tormentosas ese día. Ari, nuestra anfitriona, hizo de "
            "la comida y las bebidas un auténtico punto fuerte, y juntos "
            "sincronizaron todo a la perfección alrededor de la puesta de sol "
            "para una velada mágica. Cada detalle parecía anticipado antes "
            "incluso de que lo pidiéramos. Volveríamos a charter con Luigi y "
            "Ari sin dudarlo; no podríamos recomendarlos más."
        ),
    },
    {
        "author": 'Rayan',
        ...
        "rating": 5,
        "text": (
            "Pasamos un día maravilloso en el agua con el súper capitán Luigi y "
            "Toni cuidándonos. El barco es cómodo y tiene todos los accesorios "
            "para pasar un día precioso. La tripulación hizo todo lo posible "
            "para que este día fuera increíble y el plan que Luigi preparó para "
            "nosotros fue perfecto."
        ),
    },
    {
        "author": 'Simon',
        ...
        "rating": 5,
        "text": (
            "Qué experiencia tan excepcional. El barco es impresionante; no puedo "
            "valorarlo lo suficiente. Luigi (patrón) y Laura (anfitriona) fueron "
            "super amables y relajados y se aseguraron de que lo pasáramos genial. "
            "Paul, a través de quien reservé, también fue de gran ayuda. Los "
    ...
    },
    {
        ...
        "rating": 5,
        "text": (
            "Lo pasamos genial a bordo. Laura (azafata) y Luigi (patrón) hicieron "
            "un trabajo excelente. Fue un día precioso en el barco. La "
            "comunicación antes del viaje con Paul y Luigi fue excelente. Luigi "
            "se esforzó de verdad por atender peticiones especiales antes del "
            "viaje. ¡Gracias Laura y Luigi por recibirnos!"
        ),
    },
    {
        "author": 'Joel',
        ...
        "rating": 5,
        "text": (
            "Pasamos tres días increíbles a bordo de Limitless en Mallorca, y la "
            "experiencia superó todas las expectativas. El capitán Luigi fue "
            "excepcional: profesional, con gran conocimiento y siempre nos hizo "
            "sentir seguros mientras nos llevaba a lugares verdaderamente "
            "impresionantes alrededor de la isla. Toni, nuestra azafata, fue "
            "igualmente fantástica: atenta, amable y se aseguró de que todo "
            "funcionara a la perfección durante el viaje. El servicio de principio a "
            "fin fue excepcional, y el conocimiento local de la tripulación hizo la "
            "experiencia aún más especial. Visitamos lugares increíbles, disfrutamos "
            "cada momento a bordo y no podríamos haber pedido unos días mejores. Si "
            "está considerando un charter en Mallorca, recomiendo al capitán Luigi y "
            "a Toni sin dudarlo. ¡Gracias a los dos por un viaje inolvidable!"
        ),
    },
    {
        "author": 'Sebastien',
        ...
        "rating": 5,
        "text": (
            "Tuvimos el placer de pasar dos días inolvidables a bordo de Limitless "
            "este verano en Palma de Mallorca, y la experiencia superó todas las "
            "expectativas. Desde la cálida bienvenida del capitán Luigi y su "
            "tripulación hasta el servicio impecable durante todo el viaje, cada "
            "detalle se ejecutó a la perfección. Nuestro grupo de 11 quedó tan "
            "impresionado que volvimos a charter el yate a la semana siguiente — una "
            "experiencia que solo reforzó lo excepcional y constante que es el "
            "servicio. Si está considerando un charter en Mallorca, recomiendo "
            "Limitless sin dudarlo. El capitán Luigi, Laura y todo el equipo combinan "
            "profesionalidad, atención al detalle y hospitalidad genuina para crear "
            "una experiencia fluida e inolvidable."
        ),
    },
    {
        "author": 'Oliver',
        ...
        "rating": 5,
        "text": (
            "¡Luigi y Toni fueron increíbles! El yate estaba muy bonito y bien "
            "cuidado, con un montón de juguetes para divertirse durante el día. "
            "También nos ayudaron a coordinar el catering a bordo. Fue uno de los "
            "mejores días de nuestro viaje. El capitán Luigi conoce los mejores "
            "sitios para nadar y nos hizo sentir muy cómodos a todos. Recomiendo "
            "totalmente este chárter."
        ),
    },
    {
        "author": 'Leon',
        ...
        "rating": 5,
        "text": (
            "¡Gran experiencia! Un barco muy bonito, con buen tamaño y juguetes "
            "geniales. Tripulación muy amable que hizo un trabajo excelente en todo. "
            "Sin duda lo recomiendo; lo repetiré."
        ),
    },
    {
        "author": 'Maurice',
        ...
        "rating": 5,
        "text": (
            "Un día inolvidable y sin duda uno de los momentos destacados de nuestra "
            "estancia en Mallorca. El servicio de Luigi y Laura fue absolutamente "
            "increíble — nos sentimos muy bien atendidos durante todo el viaje. Todo "
            "fue perfecto: el barco, el ambiente, la hospitalidad y, sobre todo, la "
            "forma en que cuidaron de nosotros. Personas maravillosas que hicieron "
            "que esta experiencia fuera realmente especial. Gracias de nuevo por "
            "todo."
        ),
    },
    {
        ...
        "rating": 5,
        "text": (
            "Barco precioso con mucho espacio para los ocho. Luigi (patrón) y Rebecca "
            "no podían haber sido más acogedores: marcaron la diferencia en la "
            "calidad y el disfrute del día. Profesionales y atentos, pero también "
...
LEGAL_PAIRS = [
    ...
    ('href="maiora-yacht-charter/">The Yacht</a>', 'href="maiora-yacht-charter/">El yate</a>'),
    ('href="yacht-charter-mallorca-prices/">Prices</a>', 'href="yacht-charter-mallorca-prices/">Precios</a>'),
    ('href="index.html#avail-cal">Contact</a>', 'href="index.html#avail-cal">Contacto</a>'),
    ('<span class="footer-heading">Charters</span>', '<span class="footer-heading">Chárters</span>'),
    ('<span class="footer-heading">Destinations</span>', '<span class="footer-heading">Destinos</span>'),
    ('<a href="yacht-charter-mallorca/">Private charter</a>', '<a href="yacht-charter-mallorca/">Chárter privado</a>'),
    ('<a href="day-charter-mallorca/">Day charter</a>', '<a href="day-charter-mallorca/">Chárter de día</a>'),
    ...
    ("Data We Collect when You Contact Us", "Datos que recogemos cuando nos contacta"),
    (
        ...
        "Este sitio no tiene formulario de reserva. Si nos escribe por email o WhatsApp, tratamos la información que nos envíe (normalmente nombre, datos de contacto, fechas preferidas y un mensaje) solo para responder y gestionar un posible charter.",
    ),
    (
        ...
        "La base legal es su consentimiento y las medidas precontractuales (art. 6.1.a y b RGPD).",
    ),
    ...
    ("Analytics and Advertising (Google tag, Microsoft Clarity &amp; Google Ads)", "Análisis y publicidad (Google tag, Microsoft Clarity y Google Ads)"),
    (
        ...
        "Este sitio carga la <strong>etiqueta de Google</strong> (gtag.js) directamente — sin Google Tag Manager — para el seguimiento de conversiones y remarketing de <strong>Google Ads</strong> (ID AW-18209943491). Con su consentimiento también usamos <strong>Microsoft Clarity</strong> para grabaciones de sesión y mapas de calor. Estas herramientas nos ayudan a entender el uso del sitio y medir el rendimiento publicitario. Pueden instalarse cookies y tratarse datos como IP (normalmente truncada), dispositivo, navegador y páginas visitadas.",
    ),
    (
        ...
        "Con su consentimiento podemos registrar <strong>hasta dónde se desplaza</strong> y <strong>qué secciones ve</strong> (p. ej. galería, reseñas, precios) para mejorar el sitio, con scripts propios que envían eventos a la capa de datos de la etiqueta de Google, sin identificarle por nombre. Clarity lo proporciona Microsoft y se rige por su política de privacidad.",
    ),
    (
    ...
    (
        ...
        "Además de los datos técnicos necesarios (véase Alojamiento), usamos cookies de análisis de Microsoft Clarity solo si acepta en el banner. Cargamos la etiqueta de Google Ads (AW-18209943491) con almacenamiento publicitario denegado por defecto hasta que consienta. Puede gestionarlas o bloquearlas en la configuración del navegador.",
    ),
