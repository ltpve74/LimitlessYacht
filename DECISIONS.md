...
- **Reviews grid:** `#reviewsLoading` **and** `.reviews-grid` reserve `min-height:128rem` mobile /
  `56rem` desktop. The grid loads lazily and would jump without this. **Sized for exactly 10
